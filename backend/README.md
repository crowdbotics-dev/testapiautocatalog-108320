...
## Project Structure
    ...
    ├── testapiautocatalog_108320  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_108320`
...
2. Clone this repo and `cd testapiautocatalog_108320`
